"""Taken from https://github.com/digitalpalidictionary/dpd-db/tree/main/tools"""
...
class ProgData():
    def __init__(self) -> None:
        ...
        self.file_path = os.path.join(current_dir, "ipa.tsv")
...
if __name__ == "__main__":
    print(convert_uni_to_ipa("sāvatthī", "tts"))
    print(convert_uni_to_ipa("sāvatthī", "ipa"))